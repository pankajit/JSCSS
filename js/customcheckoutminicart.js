...
function validateOrderType(){
  ...
  function validateSingleQty(obj){
    ...
    var check_qty = parseFloat(obj.value).toFixed(2);
      ...
      {
	  if(check_qty > 70000){
	   validationstr = '<div class="validation-advice" id="advice-required-entry-qty" style="">till 70000 is allowded</div>';
      ...
      {
          var validationstr = '<div class="validation-advice" id="advice-required-entry-qty" style="">'+valid_val+'</div>';
          if(qty == ''){
