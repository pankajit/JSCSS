...
(function($) {
    ...
    $.fn.autocomplete.defaults = {
        ...
        resultsClass: 'acResults ac_results',
        selectClass: 'acSelect ac_over',
        queryParamName: 'q',
        extraParams: {},
    ...
    $.Autocompleter.prototype.createItemFromResult = function(result) {
        var self = this;
        var $li = $('<li/>');
        $li.html(this.showResult(result.value, result.data)).addClass("ac_even");
    ...
    $.Autocompleter.prototype.showResults = function(results, filter) {
        ...
        var self = this;
        var $ul = $('<ul style="max-height: 180px; overflow: auto;"></ul>');
